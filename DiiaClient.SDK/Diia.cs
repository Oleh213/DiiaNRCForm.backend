...
namespace DiiaClient.SDK
{
    public class Diia : IDiia
    {
        ...
        public Diia(string acquirerToken, string authAcquirerToken, string baseDiiaUrl, HttpClient httpClient, ICryptoService cryptoService)
        {
            var httpMethodExecutor = new HttpMethodExecutor(acquirerToken, authAcquirerToken,baseDiiaUrl, httpClient);
        ...
        public Diia(string acquirerToken, string authAcquirerToken, string diiaHost, ICryptoService cryptoService)
        : this(acquirerToken, authAcquirerToken, diiaHost, new HttpClient(), cryptoService)
        {
        }
