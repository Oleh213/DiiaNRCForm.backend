...
namespace DiiaClient.SDK.Helper
{
    ...
    {
        private static  MediaTypeWithQualityHeaderValue MEDIA_TYPE_JSON = new ("application/json");

        private ISessionTokenService _sessionTokenServiceImpl;
        private HttpClient httpClient;

        public HttpMethodExecutor(string acquirerToken, string authAcquirerToken, string baseDiiaUrl, HttpClient httpClient)
        {
            this.httpClient = httpClient;
            this._sessionTokenServiceImpl = new SessionTokenServiceImpl(acquirerToken, authAcquirerToken,baseDiiaUrl, httpClient);
        }
